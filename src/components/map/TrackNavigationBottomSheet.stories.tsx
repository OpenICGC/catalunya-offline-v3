...
import TrackNavigationBottomSheet, {
  TrackNavigationBottomSheetProps,
} from './TrackNavigationBottomSheet';
...
const sampleCoordinatesWithoutHeight: Position[] = JSON.parse(
  sampleWithoutHeight,
).coordinates as Position[];
...
const WithMapTemplate: StoryFn<TrackNavigationBottomSheetProps> = ({
  ...args
}) => {
