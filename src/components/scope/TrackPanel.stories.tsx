...
const sampleGeometryWithoutHeight: GeoJSON.LineString =
  JSON.parse(sampleWithoutHeight);
const sampleGeometryWithZeroHeight: GeoJSON.LineString =
  JSON.parse(sampleWithZeroHeight);
const sampleGeometryWithoutTimestamp: GeoJSON.LineString = JSON.parse(
...
const DeviceTemplate: StoryFn<TrackPanelProps> = (args) => (
  <Stack
    sx={{
      height: '800px',
      width: DRAWER_WIDTH,
...
const SmallDeviceTemplate: StoryFn<TrackPanelProps> = (args) => (
  <Stack
    sx={{
      height: '500px',
      width: DRAWER_WIDTH,
...
export const DeviceWithoutTimestamp = {
  render: DeviceTemplate,
...
export const DeviceWithoutHeight = {
  render: DeviceTemplate,
...
export const DeviceWithoutZeroHeight = {
  render: DeviceTemplate,
...
export const DeviceWithoutGeom = {
  render: DeviceTemplate,
